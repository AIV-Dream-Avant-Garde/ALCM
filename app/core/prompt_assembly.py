...
from app.core.context_detection import detect_context_type
from app.core.score_instructions import score_to_instruction
...
async def assemble_prompt(
    ...
    # Detect context type
    context_type = detect_context_type(context, conversation_history)
...
async def _build_layer_2_behavioral(
    ...
    for s in scores:
        ...
        instruction = score_to_instruction(s.dimension, s.sub_component, value)
        if instruction:
